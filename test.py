...
def introText():
    ...
    appearingText = 0
    while True:
        text_surface = text_font.render(texts[textIndex][:appearingText], False, "Grey")
        ...
        screen.blit(text_surface, (max_width / 2 - 7 * len(texts[textIndex]), max_height / 3))
        textTemp = '_|'
        text_surface = text_font.render(textTemp, False, "Grey")
        screen.blit(text_surface, (max_width / 2 + 15 * len(textTemp), max_height / 2))
